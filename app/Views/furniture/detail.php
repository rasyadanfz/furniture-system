...
<div class="mt-4">
    ...
    <div class="flex gap-x-10">
        ...
        <div class="flex flex-col">
            ...
            <p class="text-[20px]"><?= $furnitures->harga ?></p>
        </div>
    </div>
    <div class="mt-6">
        <form id="buyForm" action="/pesanan/create" method="post" class="flex flex-col w-[400px]">
            <div class="flex justify-between items-center">
                ...
                <input id="quantity" onchange="setTotalPrice()" type="number" name="qty" min=1 max=<?= $furnitures->stok ?> class="border text-black border-black px-3 py-1 rounded-md" placeholder="0">
            </div>
            <div>
...
<script>
    ...
    qtyTracker.addEventListener("change", (e) => {
        const total_price = (e.target.value * <?= $furnitures->harga ?>).toLocaleString('id-ID');
        price.innerHTML =  'Rp ' + total_price
    })
    ...
    function submitWithId(){
        ...
        hiddenInputPrice.value = price.innerHTML;
